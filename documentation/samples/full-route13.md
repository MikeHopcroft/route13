...
08:10:42 Cart 2 finishes loading (payload=1).  payload=1
08:10:42 Cart 2 departs location 0 for location 2.
08:11:12 Cart 0 finishes loading (payload=2).  payload=2
08:11:12 Cart 0 departs location 0 for location 1.
08:12:42 Cart 1 finishes loading (payload=5).  payload=5
...
08:21:32 Cart 0 finishes unloading (payload=0). payload=0
...
08:30:52 Cart 2 finishes unloading (payload=0). payload=0
...
08:44:00 Cart 2 finishes loading (payload=2).  payload=2
...
08:44:52 Cart 0 finishes unloading (payload=0). payload=0
...
08:45:02 Cart 1 finishes loading (payload=3).  payload=3
08:45:02 Cart 1 departs location 1 for location 2.
08:45:52 Cart 0 finishes loading (payload=2).  payload=2
...
09:15:09 Cart 2 finishes loading (payload=4).  payload=4
09:15:09 Cart 2 departs location 0 for location 2.
09:16:17 Cart 0 finishes loading (payload=5).  payload=5
...
09:20:39 Cart 1 finishes loading (payload=5).  payload=5
...
10:18:25 Cart 2 finishes loading (payload=2).  payload=2
...
10:22:55 Cart 0 finishes loading (payload=1).  payload=1
...
10:28:45 Cart 2 finishes unloading (payload=0). payload=0
...
10:43:05 Cart 0 finishes unloading (payload=0). payload=0
...
11:15:15 Cart 2 finishes loading (payload=1).  payload=1
11:15:15 Cart 2 departs location 1 for location 2.
11:17:15 Cart 1 finishes loading (payload=5).  payload=5
...
12:11:52 Cart 2 finishes loading (payload=5).  payload=5
...
12:15:22 Cart 0 finishes loading (payload=2).  payload=2
...
12:22:42 Cart 2 finishes unloading (payload=0). payload=0
...
12:35:42 Cart 0 finishes unloading (payload=0). payload=0
...
12:49:36 Cart 1 finishes loading (payload=1).  payload=1
12:49:36 Cart 1 departs location 0 for location 1.
12:49:36 Cart 0 finishes loading (payload=1).  payload=1
...
12:59:46 Cart 1 finishes unloading (payload=0). payload=0
...
13:05:06 Cart 2 finishes loading (payload=2).  payload=2
...
13:15:26 Cart 2 finishes unloading (payload=0). payload=0
...
13:41:43 Cart 2 finishes loading (payload=3).  payload=3
13:41:43 Cart 2 departs location 1 for location 0.
13:41:56 Cart 1 finishes loading (payload=3).  payload=3
...
13:43:06 Cart 0 finishes unloading (payload=0). payload=0
...
13:44:36 Cart 0 finishes loading (payload=3).  payload=3
...
15:31:20 Cart 2 finishes loading (payload=4).  payload=4
15:31:20 Cart 2 departs location 1 for location 0.
15:31:20 Cart 0 finishes loading (payload=4).  payload=4
...
15:36:20 Cart 1 finishes loading (payload=4).  payload=4
...
15:42:00 Cart 2 finishes unloading (payload=0). payload=0
15:42:00 Job 0 succeeded.
15:42:00 Cart 0 finishes unloading (payload=0). payload=0
...
15:57:00 Cart 1 finishes unloading (payload=0). payload=0
...
16:11:48 Cart 2 finishes loading (payload=1).  payload=1
...
16:18:18 Cart 0 finishes loading (payload=4).  payload=4
...
16:27:30 Cart 1 finishes loading (payload=1).  payload=1
...
16:28:58 Cart 0 finishes unloading (payload=0). payload=0
...
16:31:58 Cart 2 finishes unloading (payload=0). payload=0
...
16:37:40 Cart 1 finishes unloading (payload=0). payload=0
...
16:41:28 Cart 0 finishes loading (payload=5).  payload=5
...
16:43:34 Cart 1 finishes loading (payload=1).  payload=1
16:43:34 Cart 1 departs location 1 for location 3.
16:44:04 Cart 2 finishes loading (payload=2).  payload=2
...
16:54:24 Cart 2 finishes unloading (payload=0). payload=0
...
16:56:43 Cart 2 finishes loading (payload=3).  payload=3
...
17:03:44 Cart 1 finishes unloading (payload=0). payload=0
...
17:12:18 Cart 0 finishes unloading (payload=0). payload=0
...
17:14:14 Cart 1 finishes loading (payload=1).  payload=1
...
17:17:13 Cart 2 finishes unloading (payload=0). payload=0
...
17:23:48 Cart 0 finishes loading (payload=3).  payload=3
...
17:24:24 Cart 1 finishes unloading (payload=0). payload=0
...
17:34:18 Cart 0 finishes unloading (payload=0). payload=0
...
17:46:24 Cart 1 finishes loading (payload=4).  payload=4
...
17:47:43 Cart 2 finishes loading (payload=1).  payload=1
...
18:56:58 Cart 2 finishes loading (payload=2).  payload=2
18:56:58 Cart 2 departs location 2 for location 1.
18:57:58 Cart 0 finishes loading (payload=4).  payload=4
...
19:00:13 Cart 1 finishes loading (payload=2).  payload=2
...
19:07:18 Cart 2 finishes unloading (payload=0). payload=0
...
19:10:33 Cart 1 finishes unloading (payload=0). payload=0
...
19:17:48 Cart 2 finishes loading (payload=1).  payload=1
...
19:18:38 Cart 0 finishes unloading (payload=0). payload=0
...
19:20:38 Cart 0 finishes loading (payload=4).  payload=4
19:20:38 Cart 0 departs location 0 for location 2.
19:22:03 Cart 1 finishes loading (payload=3).  payload=3
...
19:27:58 Cart 2 finishes unloading (payload=0). payload=0
...
20:57:14 Cart 0 finishes loading (payload=2).  payload=2
20:57:14 Cart 0 departs location 1 for location 2.
20:57:44 Cart 2 finishes loading (payload=3).  payload=3
...
21:07:34 Cart 0 finishes unloading (payload=0). payload=0
...
21:18:14 Cart 2 finishes unloading (payload=0). payload=0
...
21:21:48 Cart 1 finishes loading (payload=1).  payload=1
21:21:48 Cart 1 departs location 3 for location 2.
21:23:18 Cart 2 finishes loading (payload=4).  payload=4
21:23:18 Cart 2 departs location 3 for location 1.
21:23:48 Cart 0 finishes loading (payload=5).  payload=5
...
21:31:58 Cart 1 finishes unloading (payload=0). payload=0
...
21:43:58 Cart 2 finishes unloading (payload=0). payload=0
21:43:58 Job 24 succeeded.
21:44:38 Cart 0 finishes unloading (payload=0). payload=0
...
22:09:44 Cart 1 finishes loading (payload=4).  payload=4
...
22:20:24 Cart 1 finishes unloading (payload=0). payload=0
