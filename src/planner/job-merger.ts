...
// export function cartSnapshot(carts: IterableIterator<Cart>): Map<CartId, Cart> {
...
// export function jobSnapshot(carts: Map<CartId, Cart>, jobs: IterableIterator<Job>): Map<JobId, Job> {
